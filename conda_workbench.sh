...
echo ""
/opt/miniconda3/bin/./conda update --yes conda
/opt/miniconda3/bin/./conda install --yes node-webkit libxml2 matplotlib numpy pandas scipy
/opt/miniconda3/bin/./conda install --yes ipython ipython_genutils ipywidgets ipykernel ipyparallel
/opt/miniconda3/bin/./conda install -yes pyzmq ipython-notebook ipython notebook jupyter
